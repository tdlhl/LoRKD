...
from peft.lora_fast import LoraConv3d, MultiLoraConv3d
from peft.unet_adapter import AdapterWrapperUNet
...
def main(args):
    ...
    adapter_class = MultiLoraConv3d
    model_lora = AdapterWrapperUNet(model, adapter_class, num_tasks=args.num_tasks, gamma=args.gamma, lora_alpha=args.lora_alpha)
